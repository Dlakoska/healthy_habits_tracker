    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('time', models.TimeField(blank=True, max_length=25, null=True, verbose_name='Время, когда необходимо выполнить привычку')),
                ...
                ('award', models.CharField(blank=True, max_length=100, null=True, verbose_name='Вознаграждение за выполнение')),
                ('created_date', models.DateField(blank=True, default=django.utils.timezone.now, null=True, verbose_name='Дата создания')),
                ...
                ('related_habit', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.SET_NULL, to='habits.habit', verbose_name='Связанная приятная привычка за выполнение')),
            ],
            options={
